<template>
            ...
            <div slot="headerContent">
                ...
                <div class="title">上午好，天野远子<span class="welcome-text">，要不要打一把 DOTA</span></div>
                                    ...
                                    <a-card :bordered="false" :body-style="{ padding: 0 }">
                                        <a-card-meta>
                                            <div slot="title" class="card-title">
                                                ...
                                                <a @click="exam(item.id)">{{ item.name }}</a>
                                            </div>
                                        ...
                                        <div class="project-item">
                                            <a href="/#/">作者： <a-tag color="green">{{item.author}}</a-tag></a>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            exam(id) {
                this.$router.push({ path: '/index/online', query: {id: id}}); //用go刷新
